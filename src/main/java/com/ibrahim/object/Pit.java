...
public class Pit extends ObjectParent {
    public Pit() {
        name = "Pit" ;
        collisionArea = new Rectangle(8,8,28,12) ;
        collisionAreaDefaultX = collisionArea.x ;
        collisionAreaDefaultY = collisionArea.y ;
        try {
            image = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream("/objects/pit.png")));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
